...
import { LessEqualDepth, TorusGeometry } from "three";
// import bgJpg from "./bg/bg.jpg";
...
const scaleParcent = (start, end) => (scrollParcent - start) / (end - start);
...
const playScrollAnimation = () => {
  animationScripts.forEach((animation) => {
    const { start, end, function: func } = animation;
    if(scrollParcent >= start && scrollParcent <= end) {
      func();
    }
  })
}
